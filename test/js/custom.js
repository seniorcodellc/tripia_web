...
Template: Senior Code - IT Solutions and Services Company HTML5 Template
    ...
    if (owlslider.length > 0) {
      owlslider.each(function () {
        var $this = $(this),
          ...
          $autospeed = ($this.attr('data-autospeed')) ? $this.data('autospeed') : 1500,
          $smartspeed = ($this.attr('data-smartspeed')) ? $this.data('smartspeed') : 15000,
